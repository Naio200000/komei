<?php 
    if ($CategorySelected) {
        $category = $productos[$CategorySelected];
    }
?>
    ...
    <div class="productos pb-3">
        <div class="categoria py-1 pe-2">
            ...
            <div class="">
                ...
                <option value="" selected disabled>Selecctione una Categoría</option>
        ...
        <article class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 my-2 container mx-auto" id="productos">
            <?PHP foreach ($category as $producto) { ?>
                <div class="col">
                    <div class="card tarjetas-producto">
                        ...
                        <div class="card-body">
                            <h3 class="card-title titulocard" type="button" type="button" data-bs-toggle="modal" data-bs-target="#ProductoModal" id="<?= $producto['id'] . 'boton_mostrar'?>"><?= $producto['nombre']?></h3>
                            <p class="card-text"><?= $producto['descrip'] ?></p>
                            <div class="row px2">
                                <span class="col"><?=  "$" . $producto['precio'] . ".00" ?></span>
