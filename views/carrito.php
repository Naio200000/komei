        ...
        <?php
            if(!empty($carrito)) { 
                ...
                <div class="contenedor rounded-2">
                    ...
                    <div class="productoCarritoTexto ms-0  d-flex align-items-center">
                        <p class="h4"><?= $p['nombre']?></p>
                    </div>                
                    <div class="productoCarritoCantidad ms-0 d-flex align-items-center">
                        <label for="<?= $key ?>">Cantidad: </label>
                        <input type="number" class="form-control" value="<?= $p['cantidad'] ?>" id="<?= $key ?>" name="<?= $key ?>" size="1">
                    </div>                
                    ...
                    <div class="productoCarritoPrecio ms-auto d-flex align-items-center justify-content-end">
                        <div class="">
                        ...
                        <div>
                            <span class="fw-bold fs-5 tenxt-end"><?= $p['precio']?></span>
                        </div>
                    </div>
                </div>
            <?php } }?>
